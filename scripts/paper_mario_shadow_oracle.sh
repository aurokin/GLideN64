...
# Deep telemetry tuning defaults to lean capture for faster iteration; callers can
# still opt into full per-write/per-texel verbosity when needed.
...
DEEP_OVERWRITE_LOG_INCLUDE_ALL_WRITES="${REALITYVK_PM_SHADOW_ORACLE_DEEP_OVERWRITE_LOG_INCLUDE_ALL_WRITES:-${REALITYVK_PM_DEEP_TELEMETRY_OVERWRITE_LOG_INCLUDE_ALL_WRITES:-0}}"
DEEP_OVERWRITE_LOG_INCLUDE_TEXEL_DETAIL="${REALITYVK_PM_SHADOW_ORACLE_DEEP_OVERWRITE_LOG_INCLUDE_TEXEL_DETAIL:-${REALITYVK_PM_DEEP_TELEMETRY_OVERWRITE_LOG_INCLUDE_TEXEL_DETAIL:-0}}"
