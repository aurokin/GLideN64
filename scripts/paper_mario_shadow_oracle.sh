...
# Deep telemetry tuning defaults to the previous high-detail oracle behavior, but
# callers can now opt into leaner capture settings for faster iteration.
DEEP_ARCHIVE="${REALITYVK_PM_SHADOW_ORACLE_DEEP_ARCHIVE:-${REALITYVK_PM_DEEP_TELEMETRY_ARCHIVE:-1}}"
DEEP_OVERWRITE_LOG="${REALITYVK_PM_SHADOW_ORACLE_DEEP_OVERWRITE_LOG:-${REALITYVK_PM_DEEP_TELEMETRY_OVERWRITE_LOG:-1}}"
DEEP_OVERWRITE_LOG_LIMIT="${REALITYVK_PM_SHADOW_ORACLE_DEEP_OVERWRITE_LOG_LIMIT:-${REALITYVK_PM_DEEP_TELEMETRY_OVERWRITE_LOG_LIMIT:-3000000}}"
DEEP_OVERWRITE_LOG_INCLUDE_ALL_WRITES="${REALITYVK_PM_SHADOW_ORACLE_DEEP_OVERWRITE_LOG_INCLUDE_ALL_WRITES:-${REALITYVK_PM_DEEP_TELEMETRY_OVERWRITE_LOG_INCLUDE_ALL_WRITES:-1}}"
DEEP_OVERWRITE_LOG_INCLUDE_TEXEL_DETAIL="${REALITYVK_PM_SHADOW_ORACLE_DEEP_OVERWRITE_LOG_INCLUDE_TEXEL_DETAIL:-${REALITYVK_PM_DEEP_TELEMETRY_OVERWRITE_LOG_INCLUDE_TEXEL_DETAIL:-1}}"
DEEP_TRIANGLE_PACKET_LOG="${REALITYVK_PM_SHADOW_ORACLE_DEEP_TRIANGLE_PACKET_LOG:-${REALITYVK_PM_DEEP_TELEMETRY_TRIANGLE_PACKET_LOG:-1}}"
DEEP_COMMAND_CENSUS="${REALITYVK_PM_SHADOW_ORACLE_DEEP_COMMAND_CENSUS:-${REALITYVK_PM_DEEP_TELEMETRY_COMMAND_CENSUS:-1}}"
...
rvk2_require_bool "REALITYVK_PM_SHADOW_ORACLE_DEEP_ARCHIVE" "${DEEP_ARCHIVE}"
rvk2_require_bool "REALITYVK_PM_SHADOW_ORACLE_DEEP_OVERWRITE_LOG" "${DEEP_OVERWRITE_LOG}"
rvk2_require_uint_ge "REALITYVK_PM_SHADOW_ORACLE_DEEP_OVERWRITE_LOG_LIMIT" "${DEEP_OVERWRITE_LOG_LIMIT}" 0
rvk2_require_bool "REALITYVK_PM_SHADOW_ORACLE_DEEP_OVERWRITE_LOG_INCLUDE_ALL_WRITES" "${DEEP_OVERWRITE_LOG_INCLUDE_ALL_WRITES}"
rvk2_require_bool "REALITYVK_PM_SHADOW_ORACLE_DEEP_OVERWRITE_LOG_INCLUDE_TEXEL_DETAIL" "${DEEP_OVERWRITE_LOG_INCLUDE_TEXEL_DETAIL}"
rvk2_require_bool "REALITYVK_PM_SHADOW_ORACLE_DEEP_TRIANGLE_PACKET_LOG" "${DEEP_TRIANGLE_PACKET_LOG}"
rvk2_require_bool "REALITYVK_PM_SHADOW_ORACLE_DEEP_COMMAND_CENSUS" "${DEEP_COMMAND_CENSUS}"
...
run_shadow_case() {
  ...
  env \
    ...
    REALITYVK_PM_DEEP_TELEMETRY_OVERWRITE_LOG="${DEEP_OVERWRITE_LOG}" \
    REALITYVK_PM_DEEP_TELEMETRY_OVERWRITE_LOG_LIMIT="${DEEP_OVERWRITE_LOG_LIMIT}" \
    REALITYVK_PM_DEEP_TELEMETRY_OVERWRITE_LOG_INCLUDE_ALL_WRITES="${DEEP_OVERWRITE_LOG_INCLUDE_ALL_WRITES}" \
    REALITYVK_PM_DEEP_TELEMETRY_OVERWRITE_LOG_INCLUDE_TEXEL_DETAIL="${DEEP_OVERWRITE_LOG_INCLUDE_TEXEL_DETAIL}" \
    ...
    REALITYVK_PM_DEEP_TELEMETRY_TRIANGLE_PACKET_LOG="${DEEP_TRIANGLE_PACKET_LOG}" \
    REALITYVK_PM_DEEP_TELEMETRY_COMMAND_CENSUS="${DEEP_COMMAND_CENSUS}" \
