...
struct ExecutorSummary {
	...
	u64 focusFillWriteCount = 0ULL;
	u64 focusFillWriteMaskUnsetCount = 0ULL;
	u64 focusFillWriteMaskSetCount = 0ULL;
	u64 focusFillPrevNonBlackCount = 0ULL;
	u64 focusFillNewNonBlackCount = 0ULL;
	u64 focusFillOverwriteToBlackCount = 0ULL;
	u64 focusFillPrevLumaSum = 0ULL;
	u64 focusFillNewLumaSum = 0ULL;
	u64 focusFillLumaIncreaseCount = 0ULL;
	u64 focusFillLumaDecreaseCount = 0ULL;
	u64 focusFillLumaEqualCount = 0ULL;
	u64 focusTexRectWriteCount = 0ULL;
	u64 focusTexRectWriteMaskUnsetCount = 0ULL;
	u64 focusTexRectWriteMaskSetCount = 0ULL;
	u64 focusTexRectPrevNonBlackCount = 0ULL;
	u64 focusTexRectNewNonBlackCount = 0ULL;
	u64 focusTexRectOverwriteToBlackCount = 0ULL;
	u64 focusTexRectPrevLumaSum = 0ULL;
	u64 focusTexRectNewLumaSum = 0ULL;
	u64 focusTexRectLumaIncreaseCount = 0ULL;
	u64 focusTexRectLumaDecreaseCount = 0ULL;
	u64 focusTexRectLumaEqualCount = 0ULL;
	u64 focusTexRectTexelRepeatCount = 0ULL;
	u64 focusTexRectTexelChangeCount = 0ULL;
	u64 focusTexRectTLUTAppliedCount = 0ULL;
	u64 focusTexRectTLUTLookupRepeatCount = 0ULL;
	u64 focusTexRectTLUTLookupChangeCount = 0ULL;
	u64 focusTexRectTLUTLookupInvalidCount = 0ULL;
