	...
	const ForensicsIngressSnapshot & _ingress)
{
	...
	std::fprintf(
		file,
		"\tfocus_fill_writes=%llu\tfocus_fill_write_mask_unset=%llu\tfocus_fill_write_mask_set=%llu\tfocus_fill_prev_nonblack=%llu\tfocus_fill_new_nonblack=%llu\tfocus_fill_overwrite_black=%llu\tfocus_fill_prev_luma_sum=%llu\tfocus_fill_new_luma_sum=%llu\tfocus_fill_luma_increase=%llu\tfocus_fill_luma_decrease=%llu\tfocus_fill_luma_equal=%llu\tfocus_texrect_writes=%llu\tfocus_texrect_write_mask_unset=%llu\tfocus_texrect_write_mask_set=%llu\tfocus_texrect_prev_nonblack=%llu\tfocus_texrect_new_nonblack=%llu\tfocus_texrect_overwrite_black=%llu\tfocus_texrect_prev_luma_sum=%llu\tfocus_texrect_new_luma_sum=%llu\tfocus_texrect_luma_increase=%llu\tfocus_texrect_luma_decrease=%llu\tfocus_texrect_luma_equal=%llu\tfocus_texrect_texel_repeat=%llu\tfocus_texrect_texel_change=%llu\tfocus_texrect_tlut_applied=%llu\tfocus_texrect_tlut_lookup_repeat=%llu\tfocus_texrect_tlut_lookup_change=%llu\tfocus_texrect_tlut_lookup_invalid=%llu",
		static_cast<unsigned long long>(summary.focusFillWriteCount),
		static_cast<unsigned long long>(summary.focusFillWriteMaskUnsetCount),
		static_cast<unsigned long long>(summary.focusFillWriteMaskSetCount),
		static_cast<unsigned long long>(summary.focusFillPrevNonBlackCount),
		static_cast<unsigned long long>(summary.focusFillNewNonBlackCount),
		static_cast<unsigned long long>(summary.focusFillOverwriteToBlackCount),
		static_cast<unsigned long long>(summary.focusFillPrevLumaSum),
		static_cast<unsigned long long>(summary.focusFillNewLumaSum),
		static_cast<unsigned long long>(summary.focusFillLumaIncreaseCount),
		static_cast<unsigned long long>(summary.focusFillLumaDecreaseCount),
		static_cast<unsigned long long>(summary.focusFillLumaEqualCount),
		static_cast<unsigned long long>(summary.focusTexRectWriteCount),
		static_cast<unsigned long long>(summary.focusTexRectWriteMaskUnsetCount),
		static_cast<unsigned long long>(summary.focusTexRectWriteMaskSetCount),
		static_cast<unsigned long long>(summary.focusTexRectPrevNonBlackCount),
		static_cast<unsigned long long>(summary.focusTexRectNewNonBlackCount),
		static_cast<unsigned long long>(summary.focusTexRectOverwriteToBlackCount),
		static_cast<unsigned long long>(summary.focusTexRectPrevLumaSum),
		static_cast<unsigned long long>(summary.focusTexRectNewLumaSum),
		static_cast<unsigned long long>(summary.focusTexRectLumaIncreaseCount),
		static_cast<unsigned long long>(summary.focusTexRectLumaDecreaseCount),
		static_cast<unsigned long long>(summary.focusTexRectLumaEqualCount),
		static_cast<unsigned long long>(summary.focusTexRectTexelRepeatCount),
		static_cast<unsigned long long>(summary.focusTexRectTexelChangeCount),
		static_cast<unsigned long long>(summary.focusTexRectTLUTAppliedCount),
		static_cast<unsigned long long>(summary.focusTexRectTLUTLookupRepeatCount),
		static_cast<unsigned long long>(summary.focusTexRectTLUTLookupChangeCount),
		static_cast<unsigned long long>(summary.focusTexRectTLUTLookupInvalidCount));
