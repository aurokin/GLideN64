	...
	const RDPStateSnapshot & _rdpState)
{
	...
	op.triangleShadeEnable = _semantic.triangleShadeEnable;
	op.triangleTextureEnable = _semantic.triangleTextureEnable;
	op.triangleZBufferEnable = _semantic.triangleZBufferEnable;
	op.triangleShadeR = _semantic.triangleShadeR;
	op.triangleShadeG = _semantic.triangleShadeG;
	op.triangleShadeB = _semantic.triangleShadeB;
	op.triangleShadeA = _semantic.triangleShadeA;
	op.triangleShadeDRDX = _semantic.triangleShadeDRDX;
	op.triangleShadeDGDX = _semantic.triangleShadeDGDX;
	op.triangleShadeDBDX = _semantic.triangleShadeDBDX;
	op.triangleShadeDADX = _semantic.triangleShadeDADX;
	op.triangleShadeDRDE = _semantic.triangleShadeDRDE;
	op.triangleShadeDGDE = _semantic.triangleShadeDGDE;
	op.triangleShadeDBDE = _semantic.triangleShadeDBDE;
	op.triangleShadeDADE = _semantic.triangleShadeDADE;
	op.triangleShadeDRDY = _semantic.triangleShadeDRDY;
	op.triangleShadeDGDY = _semantic.triangleShadeDGDY;
	op.triangleShadeDBDY = _semantic.triangleShadeDBDY;
	op.triangleShadeDADY = _semantic.triangleShadeDADY;
	op.triangleTexS = _semantic.triangleTexS;
	op.triangleTexT = _semantic.triangleTexT;
	op.triangleTexW = _semantic.triangleTexW;
	op.triangleTexDSDX = _semantic.triangleTexDSDX;
	op.triangleTexDTDX = _semantic.triangleTexDTDX;
	op.triangleTexDWDX = _semantic.triangleTexDWDX;
	op.triangleTexDSDE = _semantic.triangleTexDSDE;
	op.triangleTexDTDE = _semantic.triangleTexDTDE;
	op.triangleTexDWDE = _semantic.triangleTexDWDE;
	op.triangleTexDSDY = _semantic.triangleTexDSDY;
	op.triangleTexDTDY = _semantic.triangleTexDTDY;
	op.triangleTexDWDY = _semantic.triangleTexDWDY;
	op.triangleZ = _semantic.triangleZ;
	op.triangleDZDX = _semantic.triangleDZDX;
	op.triangleDZDE = _semantic.triangleDZDE;
	op.triangleDZDY = _semantic.triangleDZDY;
